...
def get_result_dataframe(
    target_datasets: List[str], image_height: int, image_width: int, target_mapper: Dict
) -> pd.DataFrame:

    dataframes = [
        get_dataframe_for_dataset(
            target_dataset, image_height, image_width, target_mapper
        )
